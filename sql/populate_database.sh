...
SQLResult=$(echo "SELECT * FROM public.parametro LIMIT 0;" | $SUDO psql  -p ${DATABASE_PORT} -U postgres -d ${DATABASE_NAME} 2>&1) # error and output to variable
