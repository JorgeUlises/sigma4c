<page orientation="paysage" >
    ...
    <table cellspacing="0" style="width: 100%;">
        <tr>
            <td style="width: 10%;">
                <img style="width: 100%" src="http://cuatroconceptos.com/wp-content/uploads/2016/05/logo_pq.png" alt="Logo HTML2PDF" >
            </td>
        ...
        <tr>
            <td style="width:55%;">
                <table cellspacing="0" style="padding: 1px; width: 100%; border: solid 2px #000000; font-size: 11pt; ">
                    ...
                    <tr>
                        <td style="width: 15%; border: solid 1px #000000;"> test </td>
                        <td style="width: 55%; border: solid 1px #000000;text-align: left;"> test 1</td>
                        <td style="width: 15%; border: solid 1px #000000;"> test 2</td>
                        <td style="width: 15%; border: solid 1px #000000;"> test 3</td>
                    </tr>
