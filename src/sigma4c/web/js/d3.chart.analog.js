            ...
            function chart(selection) {
                selection.each(function(d) {
                    ...
                    if (chartConfig) {
                        ...
                        minY = (minY > d.minimo)?d.minimo:minY;
                        maxY = (maxY < d.maximo)?d.maximo:maxY;
                    ...
                    _.each(d.yVal, function(c, i) {
                        ...
                        var lineMin = d3.svg.line()
                           .x(X)
                           .y(function (a) { return y(d.maximo); });

                        var lineMax = d3.svg.line()
                          .x(X)
                          .y(function (a) { return y(d.minimo); });
