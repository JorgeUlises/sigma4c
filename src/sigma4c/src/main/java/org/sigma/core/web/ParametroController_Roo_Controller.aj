...
privileged aspect ParametroController_Roo_Controller {
    ...
    @Autowired
    MuestraService ParametroController.muestraService;
    ...
    public String ParametroController.show(@PathVariable("id") Integer id, Model uiModel) {
    ...
    public String ParametroController.updateForm(@PathVariable("id") Integer id, Model uiModel) {
        populateEditForm(uiModel, parametroService.findParametro(id));
        return "parametroes/update";
    }
    
    @RequestMapping(value = "/{id}", method = RequestMethod.DELETE, produces = "text/html")
    public String ParametroController.delete(@PathVariable("id") Integer id, @RequestParam(value = "page", required = false) Integer page, @RequestParam(value = "size", required = false) Integer size, Model uiModel) {
